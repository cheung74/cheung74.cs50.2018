...
$(document).ready(function() {
    ...
    let options = {
        center: {lat: 39.5296, lng: -119.8138}, // Reno, Nevada
...
{
    //New latitude and longitude for map
    var myLatLng = new google.maps.LatLng(place.latitude, place.longitude);

    //Name for title and label
    var name = place.place_name + ", " + place.admin_name1;

    //Red pushpin icon
    var image = "http://maps.google.com/mapfiles/ms/micons/grn-pushpin.png"
